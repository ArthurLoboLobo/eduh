...
const en: Translations = {
  ...
  subscription: {
    usageLimitFree: 'You have reached your daily usage limit. Subscribe to Pro to continue using Eduh today.',
    subscribeToPro: 'Subscribe to Pro',
    freeDegraded: 'You have reached today\'s best model limit. The next responses will use a lighter model.',
    proDegraded: 'You have reached your daily best model limit. The next responses will use a lighter model.',
    ...
    usageWarningFreeDegraded: 'You have used {percent}% of your daily limit.',
    usageWarningFreeDegradedFinal: 'You have used {percent}% of your daily limit. After the limit, you can continue tomorrow.',
    title: 'Subscription',
    freePlan: 'Free',
    proPlan: 'Pro',
    ...
    featuresFree: [
      ...
      'Daily pause after the limit is reached',
    ],
    featuresPro: [
  ...
  promotions: {
    ...
    universityEmailDescription: 'If your account email belongs to Unicamp or USP, claim R$20 in credits. That is enough for a full month of Pro.',
    unknownTitle: 'Bonus',
    ...
    claimTooltipNavbar: 'Bonus available for your account. Claim it on the subscription page.',
    claimTooltipCard: 'Bonus available for your account.',
    claimTooltipSubscribe: 'Your balance covers one month of Pro. Subscribe here for free.',
  },
} as const;
