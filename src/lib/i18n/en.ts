...
const en: Translations = {
  ...
  subscription: {
    usageLimitFree: 'You have reached your daily usage limit. Subscribe to Pro to continue using Eduh.',
    subscribeToPro: 'Subscribe to Pro',
    freeDegraded: 'You have reached the best model limit. Responses will continue with a worse model.',
    proDegraded: 'You have reached your daily best model limit. Responses will continue with a worse model.',
    ...
    usageWarningFreeDegradedFinal: 'You have used {percent}% of your daily limit. After this, access will be blocked until tomorrow.',
    title: 'Subscription',
    freePlan: 'Free',
    proPlan: 'Pro',
