...
const ptBR: Translations = {
  ...
  subscription: {
    usageLimitFree: 'Você atingiu seu limite diário de uso. Assine o Pro para continuar utilizando o Eduh.',
    subscribeToPro: 'Assinar Pro',
    freeDegraded: 'Você atingiu o limite do melhor modelo. Respostas continuarão com um modelo pior.',
    proDegraded: 'Você atingiu o limite diário do melhor modelo. Respostas continuarão com um modelo pior.',
    usageWarningPro: 'Você já usou {percent}% do seu limite diário do melhor modelo.',
    usageWarningFreeBest: 'Você já usou {percent}% do seu limite diário do melhor modelo.',
    usageWarningFreeDegraded: 'Você já usou {percent}% do seu limite diário.',
    usageWarningFreeDegradedFinal: 'Você já usou {percent}% do seu limite diário. Após isso, o acesso será bloqueado até amanhã.',
    title: 'Assinatura',
    freePlan: 'Grátis',
    proPlan: 'Pro',
