...
const ptBR: Translations = {
  ...
  errors: {
    ...
    EMAIL_MISSING: 'Insira seu e-mail.',
    CODE_MISSING: 'Insira o código.',
    ...
    OTP_MAX_ATTEMPTS: 'Você atingiu o limite de tentativas. Solicite um novo código.',
  ...
  subscription: {
    usageLimitFree: 'Você atingiu seu limite diário de uso. Assine o Pro para continuar utilizando o Eduh today.',
    subscribeToPro: 'Assinar Pro',
    freeDegraded: 'Você atingiu o limite diário do melhor modelo. As próximas respostas usarão um modelo mais leve.',
    proDegraded: 'Você atingiu o limite diário do melhor modelo. As próximas respostas usarão um modelo mais leve.',
    usageWarningPro: 'Você usou {percent}% do seu limite diário do melhor modelo.',
    usageWarningFreeBest: 'Você usou {percent}% do seu limite diário do melhor modelo.',
    usageWarningFreeDegraded: 'Você usou {percent}% do seu limite diário.',
    usageWarningFreeDegradedFinal: 'Você usou {percent}% do seu limite diário. Depois do limite, você poderá continuar amanhã.',
    title: 'Assinatura',
    freePlan: 'Grátis',
    proPlan: 'Pro',
    ...
    featuresFree: [
      ...
      'Pausa diária após atingir o limite',
    ],
    featuresPro: [
  ...
  promotions: {
    ...
    universityEmailDescription: 'Se o email da sua conta for da Unicamp ou USP, resgate R$20 em créditos. É o suficiente para um mês inteiro de Pro.',
    unknownTitle: 'Bônus',
    ...
    claimTooltipNavbar: 'Bônus disponível para sua conta. Resgate na página de assinatura.',
    claimTooltipCard: 'Bônus disponível para sua conta.',
    claimTooltipSubscribe: 'Seu saldo cobre um mês de Pro. Assine gratuitamente aqui.',
  },
};
